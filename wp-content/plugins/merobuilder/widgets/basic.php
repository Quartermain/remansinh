...
class SiteOrigin_Panels_Widgets_Gallery extends WP_Widget {
	function __construct() {
		parent::__construct(
			...
			__( 'Gallery (Elano)', 'siteorigin-panels' ),
			array(
...
class SiteOrigin_Panels_Widgets_Clients extends WP_Widget {
	function __construct() {
		parent::__construct(
			...
			__( 'Clients Carousel (Elano)', 'siteorigin-panels' ),
			array(
...
class SiteOrigin_Panels_Widgets_Image extends WP_Widget {
	function __construct() {
		parent::__construct(
			...
			__( 'Image (Elano)', 'siteorigin-panels' ),
			array(
	...
	function widget( $args, $instance ) {
		...
		echo '<img src="'.esc_url($instance['src']).'" alt="" />';
...
class SiteOrigin_Panels_Widgets_EmbeddedVideo extends WP_Widget {
	function __construct() {
		parent::__construct(
			...
			__( 'Embedded Video (Elano)', 'siteorigin-panels' ),
			array(
...
class SiteOrigin_Panels_Widgets_Video extends WP_Widget {
	function __construct() {
		parent::__construct(
			...
			__( 'Self Hosted Video (Elano)', 'siteorigin-panels' ),
			array(
