...
function siteorigin_panels_setting($key = ''){
	...
	if( empty($settings) ){
		...
		$settings = wp_parse_args( $settings, array(
			...
			'mobile-width' => !isset( $display_settings['mobile-width'] ) ? 767 : $display_settings['mobile-width'],			// What is considered a mobile width?

			'margin-bottom' => !isset( $display_settings['margin-bottom'] ) ? 0 : $display_settings['margin-bottom'],			// Bottom margin of a cell
			'margin-sides' => !isset( $display_settings['margin-sides'] ) ? 50 : $display_settings['margin-sides'],				// Spacing between 2 cells
			...
			'inline-css' => !isset( $display_settings['inline-css'] ) ? false : $display_settings['inline-css'],				    // How to display CSS
		) );
