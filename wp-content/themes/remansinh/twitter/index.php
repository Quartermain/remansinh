...
class ezTweet {
	...
	private function getTwitterJSON() {
		...
		$tmhOAuth = new tmhOAuth(array(
			...
			'consumer_key'          => esc_attr($elano_options['twitter_consumer_key']),
			'consumer_secret'       => esc_attr($elano_options['twitter_secret_key']),
			'user_token'            => esc_attr($elano_options['twitter_token']),
			'user_secret'           => esc_attr($elano_options['twitter_token_secret']),
